...
Capistrano::Configuration.instance.load do
  ...
  namespace :chef do
    ...
    task :purge_cache, :roles => chef_role do
      run "sudo rm -rf /opt/master-chef/var/git_repos /tmp/master_chef_repos"
    end
    ...
    task :install, :roles => chef_role do
      ...
      run "#{get_prefix} curl -f -s -L https://raw.githubusercontent.com/doctolib/master-chef/#{version}/runtime/bootstrap.sh?#{version} | #{prefix} bash"
    end
